...
// Custom Social Icons since they are missing in this version of lucide-react
    ...
    <section className="py-20 md:py-32 bg-white">
      <Container className="max-w-[1200px]">
        ...
        <div className="text-center mb-20 md:mb-28">
          ...
          >
            Let&apos;s connect. Whether it&apos;s a question or a service request, we&apos;re ready to assist you.
          </motion.p>
        </div>
          ...
          >
            ...
            <div className="space-y-10 relative z-10">
              <div className="space-y-4">
                <h3 className="text-xl font-bold text-white tracking-tight">Address</h3>
              ...
              <div className="space-y-4">
                <h3 className="text-xl font-bold text-white tracking-tight">Contact</h3>
                <div className="space-y-2 font-medium">
                  <p className="text-[#9CA3AF] text-[1rem]">Phone: +012-345-789</p>
                  <p className="text-[#9CA3AF] text-[1rem]">Email: example@gmail.com</p>
                  <p className="text-[#9CA3AF] text-[1rem]">Website: www.example.com</p>
                </div>
              </div>

              <div className="space-y-4">
                <h3 className="text-xl font-bold text-white tracking-tight">Open Time</h3>
                <p className="text-[#9CA3AF] text-[1rem] leading-relaxed font-medium">
